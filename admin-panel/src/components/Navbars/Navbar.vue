<script setup>
import UserDrodown from '../Dropdowns/UserDrodown.vue';
</script>
      ...
      >
        <div class="relative flex w-full flex-wrap items-stretch">
          ...
          <input
            ...
            class="border-0 px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-whit rounded text-sm shadow outline-none focus:outline-none focus:ring w-full pl-10"
          />
        </div>
      </form>
      <!-- User -->
      <ul class="flex-col md:flex-row list-none items-center hidden md:flex">
        <UserDrodown></UserDrodown>
      </ul>
    </div>
  </nav>
  <!-- End Navbar -->
